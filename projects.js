...
window.PROJECTS = [
  ...
  {
    name: 'Vòng',
    url: 'https://vong-client.vercel.app',
    image: 'img/vong.webp',
    vi: {
      type: 'Chợ đồ cũ online', city: 'TP. Hồ Chí Minh',
      alt: 'Trang chủ Vòng: nền kem-xanh lá với tiêu đề "Good finds. A fresh start.", ô tìm kiếm và các thẻ danh mục đồ cũ',
    },
    en: {
      type: 'Secondhand marketplace', city: 'Ho Chi Minh City',
      alt: 'Vòng homepage: cream-and-green hero reading "Good finds. A fresh start.", a search bar and secondhand category chips',
    },
  },
